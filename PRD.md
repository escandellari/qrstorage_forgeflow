# PRD: qrstorage_forgeflow

## Product Summary

qrstorage_forgeflow is a mobile-friendly web app for managing physical storage boxes with QR labels. Users create boxes, print a label for each one, scan labels to open the correct box page, update contents quickly from a phone, and search the shared inventory without browsing box by box.
